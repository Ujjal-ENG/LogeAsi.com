...
function Navbar() {
    ...
    const subTotal = cart ? cart.reduce((ps, cs) => ps + cs.quantity * cs.price, 0) : cartedItem.reduce((ps, cs) => ps + cs.quantity * cs.price, 0);
                    ...
                    <div className="dropdown dropdown-end">
                        <label tabIndex={0} className="btn btn-ghost btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge badge-sm indicator-item">{cart?.length || cartedItem?.length || 0}</span>
                            </div>
                        </label>
                        <div tabIndex={0} className="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
                            <div className="card-body">
                                <span className="font-bold text-lg">{cart?.length || cartedItem?.length || 0} Items</span>
